...
public class ValidateUIHelpers {
	...
	public boolean checkElementClass(String className, String id) {
	...
	public boolean verifyElementText(By element, String textValue) {
		...
		return driver.findElement(element).getText().replaceAll("\\s+", "").equals(textValue.replaceAll("\\s+", "")); // True/False
	}
